...
APP_DESCRIPTIONS = {
    "DANA": "DANA beroperasi sebagai dompet elektronik berbasis open platform yang fleksibel karena dirancang untuk mudah terhubung dengan berbagai aplikasi lain. Selain memfasilitasi kebutuhan transaksi harian standar seperti pembayaran tagihan, pulsa, QRIS, transfer bank, dan tarik tunai, aplikasi ini memiliki keunggulan khusus pada penyediaan infrastruktur pendukung bagi pelaku usaha melalui layanan DANA Bisnis dan DANA Enterprise",
    "GoPay": "GoPay merupakan layanan keuangan digital dari GoTo Financial yang kini telah berkembang menjadi aplikasi mandiri di luar ekosistem utama Gojek. Aplikasi ini memfasilitasi transaksi non-tunai umum seperti transfer dana, pembayaran belanja, dan tagihan. Nilai tambah utamanya terletak pada fitur manajemen keuangan yang praktis, seperti pencatatan pengeluaran otomatis serta integrasi langsung dengan instrumen GoPay Tabungan by Jago",
    "ShopeePay": "ShopeePay adalah penyedia layanan uang elektronik milik PT AirPay International Indonesia yang resmi hadir sebagai aplikasi mandiri sejak tahun 2024. Fungsionalitas utamanya meliputi pemrosesan pembayaran QRIS di berbagai merchant luring, transfer saldo, dan pengelolaan beberapa sumber dana. Aplikasi ini memiliki keunggulan kompetitif yang sangat kuat dalam penyelesaian transaksi belanja daring karena terintegrasi langsung dengan ekosistem e-commerce Shopee"
}
